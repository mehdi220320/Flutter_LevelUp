            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Container(
                  margin: const EdgeInsets.only(bottom: 8),
                  decoration: BoxDecoration(
                    color: _selectedCertifications.contains(cert.name)
                  ...
                  child: CheckboxListTile(
                    title: Text(
                      ...
                      style: TextStyle(
                        color: Colors.white,
                        fontWeight: _selectedCertifications.contains(cert.name)
                            ? FontWeight.bold
                            : FontWeight.normal,
                      ),
                    ),
                    subtitle: cert.issuer.isNotEmpty
                        ...
                        : null,
                    value: _selectedCertifications.contains(cert.name),
                    onChanged: (selected) => _toggleCertification(cert.name),
